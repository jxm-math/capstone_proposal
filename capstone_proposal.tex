...
If the video has $\texttt{T}$ frames, then the video preprocessing gives as output a $\texttt{M}\times \texttt{N}\times \texttt{T}$ binary array, which is supposed to capture the movement in our scene and that will be the primary input for the project. These arrays are located in \href{https://github.com/jxm-math/capstone_project/tree/master/data/tridimensional_binary_arrays}{capstone\_project/data/tridimensional\_binary\_arrays}.
...
One may refer to \href{http://www.wisdom.weizmann.ac.il/~vision/VideoAnalysis/Demos/SpaceTimeActions/SpaceTimeActions_pami07.pdf}{Actions as Space-Time Shapes} \cite{benchmark} for a remarkable study in this field. 

\begingroup
\renewcommand{\section}[2]{}%
\begin{thebibliography}{}
	\bibitem{benchmark}
	\href{http://www.wisdom.weizmann.ac.il/~vision/SpaceTimeActions.html}{http://www.wisdom.weizmann.ac.il/~vision/SpaceTimeActions.html}
\end{thebibliography}
\endgroup
