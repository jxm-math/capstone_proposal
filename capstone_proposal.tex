...
\begin{itemize}
	\item \href{http://www.wisdom.weizmann.ac.il/~vision/VideoAnalysis/Demos/SpaceTimeActions/SpaceTimeActions_pami07.pdf}{Actions as Space-Time Shapes}
\end{itemize} 
...
The metric(s) used to estimate the quality of our clustering will comprise
...
The weight given to each measure will be assigned by refined cross-validation process.\\
